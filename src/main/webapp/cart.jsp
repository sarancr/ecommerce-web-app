                                    ...
                                    <c:forEach var="line" items="${sessionScope.cart.orderlines}">
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="deletefromcart?productId=<c:out value="${line.product.productId}"/>">×</a> 
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    ...
                                                    <input type="number" size="4" class="input-text qty text" title="Qty" value="${line.qty}" min="0" step="1">
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                <div class="coupon">
                                                    <label for="coupon_code">${sessionScope.cart.couponCode}</label>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount"><c:out value="${sessionScope.cart.total}"/></span></td>
                                        </tr>
