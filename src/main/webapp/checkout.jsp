						...
						<div class="woocommerce">
                            ...
                            <form id="login-form-wrap" class="login collapse" method="post" action="login">
                                ...
                                <p class="form-row form-row-last">
                                    ...
                                    <input type="hidden" value="/checkout.jsp" name="jsp">
                                </p>
                                <div class="clear"></div>
                            ...
                            <form id="coupon-collapse-wrap" method="post" class="checkout_coupon collapse"  action="placeorder">
                            ...
                            <form  action="placeorder" class="placeorder" method="post" name="placeorder">
											...
											<c:if test="${empty sessionScope.user}">
	                                            <div class="create-account">
	                                                ...
	                                                <p id="account_password_field" class="form-row validate-required">
	                                                    ...
	                                                    <input type="password" value="" placeholder="Password" id="account_password" name="user_password" class="input-text">
	                                                </p>
	                                                <div class="clear"></div> 
	                                            </div>
                                            </c:if>
                        ...
                        <input type="checkbox" value="1" name="ship_to_different_address" checked="checked" class="input-checkbox" id="ship-to-different-address-checkbox">
                                ...
                                <div id="order_review" style="position: relative;">
                                    <table class="shop_table">
                                        ...
                                        <tbody>
	                                        <c:forEach var="line" items="${sessionScope.cart.orderlines}">
	                                            <tr class="cart_item">
	                                                <td class="product-name">
	                                                    <c:out value="${line.product.name}"/> 
	                                                    <strong class="product-quantity">× <c:out value="${line.qty}"/></strong> </td>
	                                                <td class="product-total">
	                                                    <span class="amount">$<c:out value="${line.orderlineTotalPrice}"/></span> </td>
	                                            </tr>
	                                         </c:forEach>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount"><c:out value="${sessionScope.cart.total}"/></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount"><c:out value="${sessionScope.cart.total}"/></span></strong> </td>
                                            </tr>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            <li class="payment_method_bacs">
                                                <input type="radio" data-order_button_text="" checked="checked" value="BANK TRNS" name="payment_method" class="input-radio" id="payment_method_bacs">
